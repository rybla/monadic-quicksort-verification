...
(declare-datatypes ((IsMonad.IsMonad 1)) ((par (T0) ((junk$35$$35$IsMonad.IsMonad (junk$35$$35$IsMonad.IsMonad$35$$35$0 T0)) (IsMonad.IsMonad (IsMonad.vlift Int) (IsMonad.vbind Int) (IsMonad.vseq Int) (IsMonad.kleisli Int) (IsMonad.vbind_identity_right Int) (IsMonad.vbind_vlift Int) (IsMonad.vbind_distribution Int))))))
...
(declare-fun lit$36$IsMonad () Str)
...
(assert (distinct lit$36$main lit$36$IsMonad))

(assert (distinct GHC.Types.True GHC.Types.False))
(assert (distinct GHC.Types.EQ GHC.Types.GT GHC.Types.LT))
(assert (= (strLen lit$36$IsMonad) 6))
