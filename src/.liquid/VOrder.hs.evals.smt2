...
(declare-datatypes ((VOrder.IsOrdered 1)) ((par (T0) ((junk$35$$35$VOrder.IsOrdered (junk$35$$35$VOrder.IsOrdered$35$$35$0 T0)) (VOrder.C$58$IsOrdered (VOrder.leq Int) (VOrder.leq_reflexive Int) (VOrder.leq_transitive Int))))))
(declare-datatypes ((VNat.VNat 0)) ((par () (VNat.Zero (VNat.Suc (lqdc$35$$35$$36$select$35$$35$VNat.Suc$35$$35$1 VNat.VNat))))))
(declare-datatypes ((VList.VList 1)) ((par (T0) (VList.Nil (VList.Cons (VList.vhead T0) (VList.vtail (VList.VList T0)))))))
...
(declare-fun lit$36$IsOrdered () Str)
...
(declare-fun Function.compose () Int)
...
(declare-fun VList.vappend_zero_right () Int)
...
(declare-fun Function.identity () Int)
...
(declare-fun VList.vappend_zero () Int)
(declare-fun GHC.Base.. () Int)
(declare-fun x_Tuple22 () Int)
(declare-fun VList.vappend () Int)
(declare-fun lit$36$$39$C$58$IsOrdered () Str)
...
(declare-fun VList.vappend_zero_left () Int)
...
(declare-fun apply$35$$35$27 (Int (_ BitVec 32)) VNat.VNat)
...
(declare-fun apply$35$$35$19 (Int Str) (VList.VList Int))
(declare-fun apply$35$$35$9 (Int Bool) Str)
(declare-fun apply$35$$35$20 (Int Str) VNat.VNat)
(declare-fun apply$35$$35$5 (Int Int) (VList.VList Int))
(declare-fun apply$35$$35$17 (Int Str) (_ BitVec 32))
(declare-fun apply$35$$35$28 (Int Liquid.ProofCombinators.QED) Int)
(declare-fun apply$35$$35$33 (Int Liquid.ProofCombinators.QED) (VList.VList Int))
(declare-fun apply$35$$35$24 (Int (_ BitVec 32)) (_ BitVec 32))
(declare-fun apply$35$$35$48 (Int VNat.VNat) VNat.VNat)
(declare-fun apply$35$$35$32 (Int Liquid.ProofCombinators.QED) Liquid.ProofCombinators.QED)
(declare-fun apply$35$$35$0 (Int Int) Int)
(declare-fun apply$35$$35$34 (Int Liquid.ProofCombinators.QED) VNat.VNat)
(declare-fun apply$35$$35$31 (Int Liquid.ProofCombinators.QED) (_ BitVec 32))
(declare-fun apply$35$$35$14 (Int Str) Int)
(declare-fun apply$35$$35$46 (Int VNat.VNat) Liquid.ProofCombinators.QED)
(declare-fun apply$35$$35$30 (Int Liquid.ProofCombinators.QED) Str)
(declare-fun apply$35$$35$44 (Int VNat.VNat) Str)
(declare-fun apply$35$$35$1 (Int Int) Bool)
(declare-fun apply$35$$35$36 (Int (VList.VList Int)) Bool)
(declare-fun apply$35$$35$12 (Int Bool) (VList.VList Int))
(declare-fun apply$35$$35$45 (Int VNat.VNat) (_ BitVec 32))
(declare-fun apply$35$$35$11 (Int Bool) Liquid.ProofCombinators.QED)
(declare-fun apply$35$$35$10 (Int Bool) (_ BitVec 32))
(declare-fun apply$35$$35$26 (Int (_ BitVec 32)) (VList.VList Int))
(declare-fun apply$35$$35$13 (Int Bool) VNat.VNat)
(declare-fun apply$35$$35$6 (Int Int) VNat.VNat)
(declare-fun apply$35$$35$42 (Int VNat.VNat) Int)
(declare-fun apply$35$$35$4 (Int Int) Liquid.ProofCombinators.QED)
(declare-fun apply$35$$35$35 (Int (VList.VList Int)) Int)
(declare-fun apply$35$$35$23 (Int (_ BitVec 32)) Str)
(declare-fun apply$35$$35$16 (Int Str) Str)
(declare-fun apply$35$$35$39 (Int (VList.VList Int)) Liquid.ProofCombinators.QED)
(declare-fun apply$35$$35$8 (Int Bool) Bool)
(declare-fun apply$35$$35$40 (Int (VList.VList Int)) (VList.VList Int))
(declare-fun apply$35$$35$38 (Int (VList.VList Int)) (_ BitVec 32))
(declare-fun apply$35$$35$43 (Int VNat.VNat) Bool)
(declare-fun apply$35$$35$41 (Int (VList.VList Int)) VNat.VNat)
(declare-fun apply$35$$35$2 (Int Int) Str)
(declare-fun apply$35$$35$47 (Int VNat.VNat) (VList.VList Int))
(declare-fun apply$35$$35$37 (Int (VList.VList Int)) Str)
...
(declare-fun coerce$35$$35$27 ((_ BitVec 32)) VNat.VNat)
...
(declare-fun coerce$35$$35$19 (Str) (VList.VList Int))
(declare-fun coerce$35$$35$9 (Bool) Str)
(declare-fun coerce$35$$35$20 (Str) VNat.VNat)
(declare-fun coerce$35$$35$5 (Int) (VList.VList Int))
(declare-fun coerce$35$$35$17 (Str) (_ BitVec 32))
(declare-fun coerce$35$$35$28 (Liquid.ProofCombinators.QED) Int)
(declare-fun coerce$35$$35$33 (Liquid.ProofCombinators.QED) (VList.VList Int))
(declare-fun coerce$35$$35$24 ((_ BitVec 32)) (_ BitVec 32))
(declare-fun coerce$35$$35$48 (VNat.VNat) VNat.VNat)
(declare-fun coerce$35$$35$32 (Liquid.ProofCombinators.QED) Liquid.ProofCombinators.QED)
(declare-fun coerce$35$$35$0 (Int) Int)
(declare-fun coerce$35$$35$34 (Liquid.ProofCombinators.QED) VNat.VNat)
(declare-fun coerce$35$$35$31 (Liquid.ProofCombinators.QED) (_ BitVec 32))
(declare-fun coerce$35$$35$14 (Str) Int)
(declare-fun coerce$35$$35$46 (VNat.VNat) Liquid.ProofCombinators.QED)
(declare-fun coerce$35$$35$30 (Liquid.ProofCombinators.QED) Str)
(declare-fun coerce$35$$35$44 (VNat.VNat) Str)
(declare-fun coerce$35$$35$1 (Int) Bool)
(declare-fun coerce$35$$35$36 ((VList.VList Int)) Bool)
(declare-fun coerce$35$$35$12 (Bool) (VList.VList Int))
(declare-fun coerce$35$$35$45 (VNat.VNat) (_ BitVec 32))
(declare-fun coerce$35$$35$11 (Bool) Liquid.ProofCombinators.QED)
(declare-fun coerce$35$$35$10 (Bool) (_ BitVec 32))
(declare-fun coerce$35$$35$26 ((_ BitVec 32)) (VList.VList Int))
(declare-fun coerce$35$$35$13 (Bool) VNat.VNat)
(declare-fun coerce$35$$35$6 (Int) VNat.VNat)
(declare-fun coerce$35$$35$42 (VNat.VNat) Int)
(declare-fun coerce$35$$35$4 (Int) Liquid.ProofCombinators.QED)
(declare-fun coerce$35$$35$35 ((VList.VList Int)) Int)
(declare-fun coerce$35$$35$23 ((_ BitVec 32)) Str)
(declare-fun coerce$35$$35$16 (Str) Str)
(declare-fun coerce$35$$35$39 ((VList.VList Int)) Liquid.ProofCombinators.QED)
(declare-fun coerce$35$$35$8 (Bool) Bool)
(declare-fun coerce$35$$35$40 ((VList.VList Int)) (VList.VList Int))
(declare-fun coerce$35$$35$38 ((VList.VList Int)) (_ BitVec 32))
(declare-fun coerce$35$$35$43 (VNat.VNat) Bool)
(declare-fun coerce$35$$35$41 ((VList.VList Int)) VNat.VNat)
(declare-fun coerce$35$$35$2 (Int) Str)
(declare-fun coerce$35$$35$47 (VNat.VNat) (VList.VList Int))
(declare-fun coerce$35$$35$37 ((VList.VList Int)) Str)
...
(declare-fun smt_lambda$35$$35$27 ((_ BitVec 32) VNat.VNat) Int)
...
(declare-fun smt_lambda$35$$35$19 (Str (VList.VList Int)) Int)
(declare-fun smt_lambda$35$$35$9 (Bool Str) Int)
(declare-fun smt_lambda$35$$35$20 (Str VNat.VNat) Int)
(declare-fun smt_lambda$35$$35$5 (Int (VList.VList Int)) Int)
(declare-fun smt_lambda$35$$35$17 (Str (_ BitVec 32)) Int)
(declare-fun smt_lambda$35$$35$28 (Liquid.ProofCombinators.QED Int) Int)
(declare-fun smt_lambda$35$$35$33 (Liquid.ProofCombinators.QED (VList.VList Int)) Int)
(declare-fun smt_lambda$35$$35$24 ((_ BitVec 32) (_ BitVec 32)) Int)
(declare-fun smt_lambda$35$$35$48 (VNat.VNat VNat.VNat) Int)
(declare-fun smt_lambda$35$$35$32 (Liquid.ProofCombinators.QED Liquid.ProofCombinators.QED) Int)
(declare-fun smt_lambda$35$$35$0 (Int Int) Int)
(declare-fun smt_lambda$35$$35$34 (Liquid.ProofCombinators.QED VNat.VNat) Int)
(declare-fun smt_lambda$35$$35$31 (Liquid.ProofCombinators.QED (_ BitVec 32)) Int)
(declare-fun smt_lambda$35$$35$14 (Str Int) Int)
(declare-fun smt_lambda$35$$35$46 (VNat.VNat Liquid.ProofCombinators.QED) Int)
(declare-fun smt_lambda$35$$35$30 (Liquid.ProofCombinators.QED Str) Int)
(declare-fun smt_lambda$35$$35$44 (VNat.VNat Str) Int)
(declare-fun smt_lambda$35$$35$1 (Int Bool) Int)
(declare-fun smt_lambda$35$$35$36 ((VList.VList Int) Bool) Int)
(declare-fun smt_lambda$35$$35$12 (Bool (VList.VList Int)) Int)
(declare-fun smt_lambda$35$$35$45 (VNat.VNat (_ BitVec 32)) Int)
(declare-fun smt_lambda$35$$35$11 (Bool Liquid.ProofCombinators.QED) Int)
(declare-fun smt_lambda$35$$35$10 (Bool (_ BitVec 32)) Int)
(declare-fun smt_lambda$35$$35$26 ((_ BitVec 32) (VList.VList Int)) Int)
(declare-fun smt_lambda$35$$35$13 (Bool VNat.VNat) Int)
(declare-fun smt_lambda$35$$35$6 (Int VNat.VNat) Int)
(declare-fun smt_lambda$35$$35$42 (VNat.VNat Int) Int)
(declare-fun smt_lambda$35$$35$4 (Int Liquid.ProofCombinators.QED) Int)
(declare-fun smt_lambda$35$$35$35 ((VList.VList Int) Int) Int)
(declare-fun smt_lambda$35$$35$23 ((_ BitVec 32) Str) Int)
(declare-fun smt_lambda$35$$35$16 (Str Str) Int)
(declare-fun smt_lambda$35$$35$39 ((VList.VList Int) Liquid.ProofCombinators.QED) Int)
(declare-fun smt_lambda$35$$35$8 (Bool Bool) Int)
(declare-fun smt_lambda$35$$35$40 ((VList.VList Int) (VList.VList Int)) Int)
(declare-fun smt_lambda$35$$35$38 ((VList.VList Int) (_ BitVec 32)) Int)
(declare-fun smt_lambda$35$$35$43 (VNat.VNat Bool) Int)
(declare-fun smt_lambda$35$$35$41 ((VList.VList Int) VNat.VNat) Int)
(declare-fun smt_lambda$35$$35$2 (Int Str) Int)
(declare-fun smt_lambda$35$$35$47 (VNat.VNat (VList.VList Int)) Int)
(declare-fun smt_lambda$35$$35$37 ((VList.VList Int) Str) Int)
...
(declare-fun lam_arg$35$$35$1$35$$35$42 () VNat.VNat)
(declare-fun lam_arg$35$$35$2$35$$35$42 () VNat.VNat)
(declare-fun lam_arg$35$$35$3$35$$35$42 () VNat.VNat)
(declare-fun lam_arg$35$$35$4$35$$35$42 () VNat.VNat)
(declare-fun lam_arg$35$$35$5$35$$35$42 () VNat.VNat)
(declare-fun lam_arg$35$$35$6$35$$35$42 () VNat.VNat)
(declare-fun lam_arg$35$$35$7$35$$35$42 () VNat.VNat)
(declare-fun lam_arg$35$$35$1$35$$35$35 () (VList.VList Int))
(declare-fun lam_arg$35$$35$2$35$$35$35 () (VList.VList Int))
(declare-fun lam_arg$35$$35$3$35$$35$35 () (VList.VList Int))
(declare-fun lam_arg$35$$35$4$35$$35$35 () (VList.VList Int))
(declare-fun lam_arg$35$$35$5$35$$35$35 () (VList.VList Int))
(declare-fun lam_arg$35$$35$6$35$$35$35 () (VList.VList Int))
(declare-fun lam_arg$35$$35$7$35$$35$35 () (VList.VList Int))
...
(assert (distinct lit$36$VOrder lit$36$$39$C$58$IsOrdered lit$36$main lit$36$IsOrdered))
...
(assert (= (strLen lit$36$IsOrdered) 8))
(assert (= (strLen lit$36$main) 4))
(assert (= (strLen lit$36$$39$C$58$IsOrdered) 11))
(assert (= (strLen lit$36$VOrder) 6))
(push 1)
