...
(declare-datatypes ((Data.Functor.Classes.Functor 1)) ((par (T0) ((junk$35$$35$Data.Functor.Classes.Functor (junk$35$$35$Data.Functor.Classes.Functor$35$$35$0 T0)) (Data.Functor.Classes.C$58$Functor (Data.Functor.Classes.fmap Int) (Data.Functor.Classes.$60$$36$ Int))))))
(declare-datatypes ((Data.Functor.Classes.VFunctor 1)) ((par (T0) ((junk$35$$35$Data.Functor.Classes.VFunctor (junk$35$$35$Data.Functor.Classes.VFunctor$35$$35$0 T0)) (Data.Functor.Classes.C$58$VFunctor (Data.Functor.Classes.$36$p1VFunctor (Data.Functor.Classes.Functor T0)) (Data.Functor.Classes.lawFunctorId Int) (Data.Functor.Classes.lawFunctorComposition Int))))))
(declare-datatypes ((Data.Functor.Classes.Applicative 1)) ((par (T0) ((junk$35$$35$Data.Functor.Classes.Applicative (junk$35$$35$Data.Functor.Classes.Applicative$35$$35$0 T0)) (Data.Functor.Classes.C$58$Applicative (Data.Functor.Classes.$36$p1Applicative (Data.Functor.Classes.Functor T0)) (Data.Functor.Classes.pure Int) (Data.Functor.Classes.ap Int) (Data.Functor.Classes.vliftA2 Int) (Data.Functor.Classes.$42$$62$ Int) (Data.Functor.Classes.$60$$42$ Int))))))
(declare-datatypes ((Data.Functor.Classes.Monad 1)) ((par (T0) ((junk$35$$35$Data.Functor.Classes.Monad (junk$35$$35$Data.Functor.Classes.Monad$35$$35$0 T0)) (Data.Functor.Classes.C$58$Monad (Data.Functor.Classes.$36$p1Monad (Data.Functor.Classes.Applicative T0)) (Data.Functor.Classes.vbind Int) (Data.Functor.Classes.return Int) (Data.Functor.Classes.mseq Int))))))
(declare-datatypes ((Data.Functor.Classes.VApplicative 1)) ((par (T0) ((junk$35$$35$Data.Functor.Classes.VApplicative (junk$35$$35$Data.Functor.Classes.VApplicative$35$$35$0 T0)) (Data.Functor.Classes.C$58$VApplicative (Data.Functor.Classes.$36$p1VApplicative (Data.Functor.Classes.VFunctor T0)) (Data.Functor.Classes.$36$p2VApplicative (Data.Functor.Classes.Applicative T0)) (Data.Functor.Classes.lawApplicativeId Int) (Data.Functor.Classes.lawApplicativeComposition Int) (Data.Functor.Classes.lawApplicativeHomomorphism Int) (Data.Functor.Classes.lawApplicativeInterchange Int))))))
(declare-datatypes ((Data.Functor.Classes.IsMonad 1)) ((par (T0) ((junk$35$$35$Data.Functor.Classes.IsMonad (junk$35$$35$Data.Functor.Classes.IsMonad$35$$35$0 T0)) (Data.Functor.Classes.C$58$IsMonad (Data.Functor.Classes.$36$p1IsMonad (Data.Functor.Classes.VApplicative T0)) (Data.Functor.Classes.$36$p2IsMonad (Data.Functor.Classes.Monad T0)) (Data.Functor.Classes.lawMonad1 Int) (Data.Functor.Classes.lawMonad2 Int) (Data.Functor.Classes.lawMonad3 Int) (Data.Functor.Classes.lawMonadReturn Int))))))
...
(assert (distinct lit$36$main lit$36$Test))
