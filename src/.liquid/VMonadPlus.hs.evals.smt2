...
(declare-datatypes ((IsMonadPlus.IsMonadPlus 1)) ((par (T0) ((junk$35$$35$IsMonadPlus.IsMonadPlus (junk$35$$35$IsMonadPlus.IsMonadPlus$35$$35$0 T0)) (IsMonadPlus.IsMonadPlus (IsMonadPlus.vlift Int) (IsMonadPlus.vbind Int) (IsMonadPlus.vseq Int) (IsMonadPlus.kleisli Int) (IsMonadPlus.vepsilon Int) (IsMonadPlus.vmadd Int) (IsMonadPlus.vmadd_ap Int) (IsMonadPlus.vbind_identity_right Int) (IsMonadPlus.vbind_vlift Int) (IsMonadPlus.vbind_distribution Int) (IsMonadPlus.vbind_identity_left Int) (IsMonadPlus.vseq_identity_right Int) (IsMonadPlus.vmadd_distribute_left Int) (IsMonadPlus.vmadd_distribute_right Int))))))
...
(declare-fun lit$36$IsMonadPlus () Str)
...
(assert (distinct lit$36$IsMonadPlus lit$36$main))
...
(assert (= (strLen lit$36$IsMonadPlus) 10))
(push 1)
