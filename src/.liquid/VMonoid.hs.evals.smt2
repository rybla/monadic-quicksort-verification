...
(declare-datatypes ((IsMonoid.IsMonoid 1)) ((par (T0) ((IsMonoid.IsMonoid (IsMonoid.semigroup (IsSemigroup.IsSemigroup T0)) (IsMonoid.epsilon T0) (IsMonoid.op_associative Int) (IsMonoid.op_identity Int))))))
...
(declare-fun IsSemigroup.$36$tcIsSemigroup () Int)
...
(declare-fun lit$36$$39$IsMonoid () Str)
...
(declare-fun lit$36$IsMonoid () Str)
...
(assert (distinct lit$36$IsMonoid lit$36$$39$IsMonoid lit$36$main))
...
(assert (= (strLen lit$36$$39$IsMonoid) 8))
(assert (= (strLen lit$36$IsMonoid) 7))
(push 1)
