...
(declare-datatypes ((IsEq.IsEq 1)) ((par (T0) ((junk$35$$35$IsEq.IsEq (junk$35$$35$IsEq.IsEq$35$$35$0 T0)) (IsEq.IsEq (IsEq.equ Int) (IsEq.equ_reflexive Int) (IsEq.eq_symmetric Int) (IsEq.equ_transitive Int))))))
...
(declare-fun lit$36$$39$IsEq () Str)
...
(declare-fun IsEq.equ_symmetric () Int)
...
(declare-fun lq_tmp$36$x$35$$35$709 () Int)
...
(assert (distinct lit$36$main lit$36$$39$IsEq lit$36$IsEq))
...
(assert (= (strLen lit$36$IsEq) 3))
(assert (= (strLen lit$36$$39$IsEq) 4))
