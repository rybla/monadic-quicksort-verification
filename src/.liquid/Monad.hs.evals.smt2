...
(declare-datatypes ((Monad.Monad 1)) ((par (T0) ((junk$35$$35$Monad.Monad (junk$35$$35$Monad.Monad$35$$35$0 T0)) (Monad.C$58$Monad (Monad.vlift Int) (Monad.vbind Int) (Monad.$62$$62$$61$ Int) (Monad.seq Int) (Monad.$62$$62$ Int) (Monad.kleisli Int) (Monad.$62$$61$$62$ Int) (Monad.vbind_identity_right Int) (Monad.vlift_vbind Int) (Monad.vbind_distribute_left Int) (Monad.vlift2 Int))))))
(declare-datatypes ((Monad.MonadPlus 1)) ((par (T0) ((junk$35$$35$Monad.MonadPlus (junk$35$$35$Monad.MonadPlus$35$$35$0 T0)) (Monad.C$58$MonadPlus (Monad.$36$p1MonadPlus (Monad.Monad T0)) (Monad.mzero Int) (Monad.mplus Int) (Monad.$60$$43$$62$ Int) (Monad.mplus_ap Int) (Monad.$36$$43$$36$ Int) (Monad.vbind_identity_left Int) (Monad.seq_identity_right Int) (Monad.mplus_distribute_left Int) (Monad.mplus_distribute_right Int) (Monad.guard Int))))))
...
(declare-fun b$35$$35$a4bb () Bool)
(declare-fun Monad.$36$dmguard () Int)
(declare-fun Monad.$36$dmvlift2 () Int)
...
(declare-fun Monad.$36$dm$62$$62$$61$ () Int)
(declare-fun GHC.List.replicate () Int)
(declare-fun GHC.List.zipWith () Int)
(declare-fun fix$36$$36$dMonadPlus_a4pv () (Monad.MonadPlus Int))
(declare-fun GHC.Classes.$62$$61$ () Int)
(declare-fun GHC.Num.fromInteger () Int)
(declare-fun papp3 () Int)
(declare-fun GHC.Generics.SSym () Int)
(declare-fun GHC.List.span () Int)
(declare-fun Monad.$36$dm$62$$62$ () Int)
...
(declare-fun Monad.$36$dm$60$$43$$62$ () Int)
...
(declare-fun Monad.$36$dmmplus_ap () Int)
...
(declare-fun lit$36$Monad () Str)
(declare-fun GHC.Integer.Type.S$35$ () Int)
(declare-fun GHC.List.scanl1 () Int)
(declare-fun Data.Either.Right () Int)
(declare-fun Data.Function.id () Int)
(declare-fun Monad.$36$dm$62$$61$$62$ () Int)
(declare-fun GHC.Num.$45$ () Int)
(declare-fun len () Int)
(declare-fun papp6 () Int)
(declare-fun GHC.Base.. () Int)
(declare-fun Monad.$36$dmkleisli () Int)
...
(declare-fun fix$36$$36$dMonad_a4ov () (Monad.Monad Int))
...
(declare-fun f$35$$35$a4bB () Int)
(declare-fun GHC.Generics.STrue () Int)
(declare-fun g$35$$35$a4bC () Int)
...
(assert (distinct lit$36$MonadPlus lit$36$Monad lit$36$main))
...
(assert (= (strLen lit$36$Monad) 5))
(assert (= (strLen lit$36$MonadPlus) 9))
(push 1)
