...
(declare-fun lit$36$IsSemigroup () Str)
...
(declare-fun lit$36$$39$IsSemigroup () Str)
...
(assert (distinct lit$36$$39$IsSemigroup lit$36$IsSemigroup lit$36$main))
...
(assert (= (strLen lit$36$IsSemigroup) 10))
(assert (= (strLen lit$36$$39$IsSemigroup) 11))
(push 1)
