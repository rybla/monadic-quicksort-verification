...
ipartl_spec_steps4to5_lemma2 = undefined -- TODO
...
ipartl_spec_steps4to5 p i x xs ys zs = undefined
...
@-}
ipartl_spec_steps6to7 :: (Equality (M (Natural, Natural)), Equality (M (Natural, Natural, Natural)), Equality (M (List Int, List Int, List Int))) => Int -> Natural -> Int -> List Int -> List Int -> List Int -> EqualityProp (M (Natural, Natural))
ipartl_spec_steps6to7 = undefined -- TODO
