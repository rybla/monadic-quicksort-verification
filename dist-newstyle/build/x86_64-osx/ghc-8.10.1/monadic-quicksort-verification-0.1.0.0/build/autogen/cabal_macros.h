...
/* package monadic-quicksort-verification-0.1.0.0 */
#ifndef VERSION_monadic_quicksort_verification
#define VERSION_monadic_quicksort_verification "0.1.0.0"
#endif /* VERSION_monadic_quicksort_verification */
#ifndef MIN_VERSION_monadic_quicksort_verification
#define MIN_VERSION_monadic_quicksort_verification(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_monadic_quicksort_verification */
...
#define CURRENT_PACKAGE_KEY "monadic-quicksort-verification-0.1.0.0-inplace"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "monadic-quicksort-verification-0.1.0.0-inplace"
