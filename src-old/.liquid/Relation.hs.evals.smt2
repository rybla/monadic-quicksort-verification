...
(declare-fun lit$36$Relation () Str)
...
(assert (distinct lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace lit$36$Relation))
...
(assert (= (strLen lit$36$Relation) 8))
