...
(assert (distinct lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace lit$36$VUnit))

(assert (distinct GHC.Types.True GHC.Types.False))
(assert (distinct GHC.Types.EQ GHC.Types.GT GHC.Types.LT))
(assert (= (strLen lit$36$VUnit) 5))
(assert (= (strLen lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace) 46))
(push 1)
(assert (and (and (= VV$35$$35$F$35$$35$2 GHC.Tuple.$40$$41$) (= VV$35$$35$F$35$$35$2 GHC.Tuple.$40$$41$)) (not GHC.Types.False) GHC.Types.True))
(push 1)
(assert (not (= VV$35$$35$F$35$$35$2 GHC.Tuple.$40$$41$)))
(check-sat)
; SMT Says: Unsat
(pop 1)
(pop 1)
