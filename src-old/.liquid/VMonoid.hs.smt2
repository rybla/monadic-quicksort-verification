...
(declare-datatypes ((VMonoid.VMonoid 1)) ((par (T0) ((VMonoid.VMonoid (VMonoid.iSemigroup (VSemigroup.VSemigroup T0)) (VMonoid.epsilon T0) (VMonoid.op_identity Int))))))
...
(declare-fun lit$36$$39$VMonoid () Str)
...
(declare-fun lit$36$VMonoid () Str)
...
(assert (distinct lit$36$VMonoid lit$36$$39$VMonoid lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace))
...
(assert (= (strLen lit$36$$39$VMonoid) 8))
(assert (= (strLen lit$36$VMonoid) 7))
(exit)
