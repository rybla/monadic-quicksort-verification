...
(declare-datatypes ((EqualityMonadic.SMTEquality 1)) ((par (T0) ((EqualityMonadic.SMTE_inject (EqualityMonadic.SMTE_inject$35$$35$x T0) (EqualityMonadic.SMTE_inject$35$$35$y T0) (EqualityMonadic.SMTE_inject$35$$35$_ Int))))))
(declare-datatypes ((EqualityMonadic.PropositionalEquality 1)) ((par (T0) ((EqualityMonadic.PE_inject (EqualityMonadic.PE_inject$35$$35$x T0) (EqualityMonadic.PE_inject$35$$35$y T0) (EqualityMonadic.PE_inject$35$$35$_ Int)) (EqualityMonadic.PE_extend (EqualityMonadic.PE_extend$35$$35$f Int) (EqualityMonadic.PE_extend$35$$35$g Int) (EqualityMonadic.PE_extend$35$$35$lqdc$35$$35$$36$select$35$$35$EqualityMonadic.PE_extend$35$$35$1 Int)) (EqualityMonadic.PE_context (EqualityMonadic.PE_context$35$$35$x Int) (EqualityMonadic.PE_context$35$$35$y Int) (EqualityMonadic.PE_context$35$$35$_ (EqualityMonadic.PropositionalEquality Int)) (EqualityMonadic.PE_context$35$$35$ctx Int))))))
(declare-datatypes ((EqualityMonadic.IsEquality 2)) ((par (T0 T1) ((junk$35$$35$EqualityMonadic.IsEquality (junk$35$$35$EqualityMonadic.IsEquality$35$$35$0 T0) (junk$35$$35$EqualityMonadic.IsEquality$35$$35$1 T1)) (EqualityMonadic.IsEquality (EqualityMonadic.eq Int) (EqualityMonadic.reflexive Int) (EqualityMonadic.symmetric Int) (EqualityMonadic.transitive Int))))))
(declare-datatypes ((EqualityMonadic.BaseEquality 1)) ((par (T0) ((junk$35$$35$EqualityMonadic.BaseEquality (junk$35$$35$EqualityMonadic.BaseEquality$35$$35$0 T0)) (EqualityMonadic.BaseEquality (EqualityMonadic.BaseEquality$35$$35$lqdc$35$$35$$36$select$35$$35$EqualityMonadic.BaseEquality$35$$35$1 Int))))))
(declare-fun x$35$$35$a7iS () Int)
...
(declare-fun lit$36$SMTEquality () Str)
...
(declare-fun lit$36$$39$PE_inject () Str)
...
(declare-fun EqualityMonadic.id () Int)
(declare-fun lit$36$$39$IsEquality () Str)
(declare-fun GHC.Types.KindRepTYPE () Int)
(declare-fun GHC.List.dropWhile () Int)
(declare-fun autolen () Int)
(declare-fun GHC.Integer.Type.$36$WJn$35$ () Int)
(declare-fun EqualityMonadic.isReflexive_SMTEquality () Int)
(declare-fun GHC.Real.$94$ () Int)
(declare-fun head () Int)
(declare-fun GHC.Real.mod () Int)
(declare-fun lit$36$BaseEquality () Str)
(declare-fun GHC.Types.TupleRep () Int)
(declare-fun x$35$$35$a7iT () Int)
...
(declare-fun lit$36$EqualityMonadic () Str)
...
(declare-fun lq_tmp$36$x$35$$35$1971 () Int)
...
(declare-fun lit$36$$39$BaseEquality () Str)
(declare-fun lit$36$IsEquality () Str)
(declare-fun lq_tmp$36$x$35$$35$1786 () Int)
(declare-fun isAdmit () Int)
(declare-fun lit$36$$39$PE_context () Str)
...
(declare-fun EqualityMonadic.isEquality_SMTEquality () (EqualityMonadic.IsEquality (EqualityMonadic.SMTEquality Int) Int))
...
(declare-fun lit$36$$39$SMTE_inject () Str)
...
(declare-fun EqualityMonadic.eq_base () Int)
...
(declare-fun EqualityMonadic.$36$WPE_context () Int)
(declare-fun GHC.List.scanr () Int)
(declare-fun GHC.Num.negate () Int)
(declare-fun lit$36$$39$PE_extend () Str)
(declare-fun GHC.Real.fromIntegral () Int)
(declare-fun GHC.Maybe.Just () Int)
(declare-fun GHC.Classes.min () Int)
(declare-fun GHC.List.head () Int)
(declare-fun lqdc$35$$35$$36$select$35$$35$GHC.Tuple.$40$$44$$41$$35$$35$1 () Int)
(declare-fun lit$36$src$47$EqualityMonadic.hs () Str)
...
(assert (distinct lit$36$src$47$EqualityMonadic.hs lit$36$$39$PE_extend lit$36$$39$SMTE_inject lit$36$$39$PE_context lit$36$IsEquality lit$36$$39$BaseEquality lit$36$undefined lit$36$PropositionalEquality lit$36$EqualityMonadic lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace lit$36$BaseEquality lit$36$$39$IsEquality lit$36$$39$PE_inject lit$36$SMTEquality))
...
(assert (= (strLen lit$36$SMTEquality) 11))
(assert (= (strLen lit$36$$39$PE_inject) 10))
(assert (= (strLen lit$36$$39$IsEquality) 11))
(assert (= (strLen lit$36$BaseEquality) 12))
(assert (= (strLen lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace) 46))
(assert (= (strLen lit$36$EqualityMonadic) 15))
(assert (= (strLen lit$36$PropositionalEquality) 21))
(assert (= (strLen lit$36$undefined) 9))
(assert (= (strLen lit$36$$39$BaseEquality) 13))
(assert (= (strLen lit$36$IsEquality) 10))
(assert (= (strLen lit$36$$39$PE_context) 11))
(assert (= (strLen lit$36$$39$SMTE_inject) 12))
(assert (= (strLen lit$36$$39$PE_extend) 10))
(assert (= (strLen lit$36$src$47$EqualityMonadic.hs) 22))
(push 1)
