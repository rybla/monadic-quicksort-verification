...
(declare-fun lit$36$$39$VIdentity () Str)
...
(declare-fun VIdentity.vmapF_VIdentity () Int)
(declare-fun lit$36$VIdentity () Str)
(declare-fun GHC.Tuple.$40$$41$ () Int)
(declare-fun GHC.Types.I$35$ () Int)
(declare-fun f$35$$35$a7a4 () Int)
(declare-fun GHC.Types.KindRepFun () Int)
(declare-fun VMonad.liftM_f_second () Int)
(declare-fun ds_d7b1 () (VIdentity.VIdentity Int))
...
(declare-fun ds_d7b2 () (VIdentity.VIdentity Int))
(declare-fun Function.vcomp () Int)
(declare-fun GHC.Types.EQ () Int)
(declare-fun lq_tmp$36$x$35$$35$703 () (VIdentity.VIdentity Int))
...
(declare-fun VIdentity.vmapF_vid_VIdentity () Int)
...
(assert (distinct lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace lit$36$VIdentity lit$36$$39$VIdentity))
...
(assert (= (strLen lit$36$$39$VIdentity) 10))
(assert (= (strLen lit$36$VIdentity) 9))
