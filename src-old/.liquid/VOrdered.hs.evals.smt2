...
(declare-fun lit$36$VOrdered () Str)
...
(declare-fun lit$36$$39$VOrdered () Str)
...
(assert (distinct lit$36$$39$VOrdered lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace lit$36$VOrdered))
