...
(declare-datatypes ((VPartitioned.VPartitioned 1)) ((par (T0) ((junk$35$$35$VPartitioned.VPartitioned (junk$35$$35$VPartitioned.VPartitioned$35$$35$0 T0)) (VPartitioned.VPartitioned (VPartitioned.veq Int) (VPartitioned.veq_reflexive Int) (VPartitioned.veq_symmetric Int) (VPartitioned.veq_transitive Int))))))
...
(declare-fun lit$36$$39$VPartitioned () Str)
...
(declare-fun lit$36$VPartitioned () Str)
...
(assert (distinct lit$36$VPartitioned lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace lit$36$$39$VPartitioned))
