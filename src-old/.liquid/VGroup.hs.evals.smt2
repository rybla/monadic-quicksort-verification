...
(declare-datatypes ((VGroup.Group 1)) ((par (T0) ((VGroup.Group (VGroup.iSemigroup (VSemigroup.VSemigroup T0)) (VGroup.epsilon T0) (VGroup.invert Int) (VGroup.op_identity Int) (VGroup.op_invertible Int))))))
...
(declare-fun VSemigroup.$36$tcVSemigroup () Int)
(declare-fun GHC.Tuple.$40$$44$$44$$41$ () Int)
(declare-fun papp4 () Int)
(declare-fun GHC.Types.Module () Int)
(declare-fun GHC.List.zip () Int)
(declare-fun GHC.Tuple.$40$$41$ () Int)
(declare-fun lit$36$$39$Group () Str)
...
(assert (distinct lit$36$VGroup lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace lit$36$$39$Group lit$36$Group))
...
(assert (= (strLen lit$36$Group) 5))
(assert (= (strLen lit$36$$39$Group) 6))
(assert (= (strLen lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace) 46))
(assert (= (strLen lit$36$VGroup) 6))
(push 1)
