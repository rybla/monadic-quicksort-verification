...
(declare-fun lit$36$VSemigroup () Str)
...
(declare-fun lit$36$$39$VSemigroup () Str)
...
(assert (distinct lit$36$$39$VSemigroup lit$36$VSemigroup lit$36$monadic$45$quicksort$45$verification$45$0.1.0.0$45$inplace))
...
(assert (= (strLen lit$36$VSemigroup) 10))
(assert (= (strLen lit$36$$39$VSemigroup) 11))
(exit)
